...
\begin{figure}[t]
	\begin{center}
		$\begin{array}{@{\hspace{-0.00in}}c@{\hspace{0.05in}}c}
			\includegraphics[width=1.5in]{images/resnet_normalized_color.png}
			&\includegraphics[width=1.5in]{images/vgg-normalized-color.png}
			\\
			(a)  &  (b)
			\end{array}$
	\end{center}
	\caption{ The loss landscapes of two different models trained on the same dataset for the same number of epochs: 
	(a) ResNet50, and (b) VGG11. } \label{fig:coparison_of_landscapes}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		$\begin{array}{@{\hspace{-0.00in}}c@{\hspace{0.05in}}c}
			\includegraphics[width=1.5in]{../images/Resnet-0.5to0.5_high_res/rainbow_gradient_with_height.png}
			&\includegraphics[width=1.5in]{../images/Resnet-0.5to0.5_high_res/contours-in-air.png}
			\\
			(a)  &  (b)
			\end{array}$
	\end{center}
	\caption{ VGG11 random directions visualized using two techniques: color + height and contours + height. } \label{fig:coparison_of_landscapes}
\end{figure}
