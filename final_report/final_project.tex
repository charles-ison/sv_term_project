...
\teaser{
	...
	$\begin{array}{@{\hspace{-0.00in}}c@{\hspace{0.10in}}c@{\hspace{0.10in}}c@{\hspace{0.05in}}c}
		\includegraphics[width=2in]{../images/Resnet_Random-Images-Ultra-High-Resolution/rainbow_gradient_with_height.png}
		&\includegraphics[width=2in]{../images/Resnet_Random-Images-Ultra-High-Resolution/contours-in-air.png}
			\\
			(a)  &  (b)
		\end{array}$
