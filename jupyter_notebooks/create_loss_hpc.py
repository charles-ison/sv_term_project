# -*- coding: utf-8 -*-
"""create_loss_ply_file2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ax7uK9-_RSbNW4aNqPBduuJcc7QmUCTS
"""
...
def get_pca_losses(model, training_loader, testing_loader, criterion, device, optimizer, historical_weights, historical_losses, title):
...
def create_pca_loss_landscape(model, training_loader, testing_loader, criterion, device, optimizer, historical_weights, historical_losses, graph_title):
    X, Y, Z = get_pca_losses(model, training_loader, testing_loader, criterion, device, optimizer, historical_weights, historical_losses, graph_title.replace(' ', '_'))
    plot_figure(X, Y, Z, graph_title)
