# -*- coding: utf-8 -*-
"""create_loss_ply_file1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1O3iGYjTlePV8vjci4bafqJOqk5Y6xW5s
"""
...
OUTPUT_DIR = f"runs/{NUM_EPOCHS}_epochs_{time_now.hour}:{time_now.minute}_{time_now.month}_{time_now.day}_{time_now.year}"
os.mkdir(OUTPUT_DIR)
...
def create_loss_landscapes(model, training_loader, testing_loader, device, graph_title):
    ...
    historical_weights = pre_train_and_test(model, training_loader, testing_loader, criterion, optimizer)
